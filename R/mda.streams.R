...
#' 
#' \item \code{\link{get_nwis_df}} - downloads data from NWIS to the local R session
#' 
#' }
#' 
#' 
...
#' \itemize{
#' 
#' \item \code{\link{create_site}} - given a site ID, create an SB node for the site
#' 
#' \item \code{\link{post_nwis_ts}} - download the specified NWIS data and post it to SB
#' 
#' \item \code{\link{post_ts}} - given a data.frame with data, do a little format checking and post those data to SB. Where would such data come from?
#' 
#' \item \code{\link{post_watershed}} - given a vector of watershed filenames, posts those files to SB. Where do the files come from?
#' 
#' }
#' 
#' 
...
#' 
#' \item \code{\link{split_site}} - currently only used in get_nwis_df. Takes site ID (e.g. "nwis_2345621") and returns the part after the underscore.
#' 
#' \item \code{mda_helpers.R} - utilities used within the package. Includes functions make_ts_variable, get_ts_prefix, get_ts_extension, get_ts_delim, and get_title.
#' 
#' }
#' 
#' @docType package
